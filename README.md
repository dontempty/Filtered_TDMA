...
`apps/channel_cpu/`은 **난류 채널 유동**(아임계 Re_b≈2857) 솔버입니다. 좌표 규약:
...
교환 왕복 정합성을 검증(`make tests`). 채널-specific 세부는 추후 `channel_cpu/README.md`로
분리 예정.
...
| 채널 유동 구조 | `apps/channel_cpu/` (`MomentumSolver`, `TdmaSolver`, …) |
