...
# Separate output dirs (*_h200_222) so this does not clobber other jobs.
# Submit:  sbatch apps/channel_gpu/sbatch_re550_filtered_h200_222.sh
set -u
...
mkdir -p log statistics/re550_f_h200_222 instant/re550_f_h200_222 \
         restart_out/re550_f_h200_222 restart_in/re550_f_h200_222

rm -f instant/re550_f_h200_222/* statistics/re550_f_h200_222/* restart_out/re550_f_h200_222/*
...
mpirun --bind-to none --mca pml ucx --mca osc ucx --mca coll ^hcoll \
       -np 8 "${BIN}" input/PARA_INPUT_re550_filtered_h200_222.dat
rc_f=$?
t1=$(date +%s)
