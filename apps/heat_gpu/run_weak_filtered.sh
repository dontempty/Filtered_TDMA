...
#  CSV → results/weak/timing_<N>_<npxnpynpz>_filtered_v2.csv
...
RESULTS="${PROJ}/apps/heat_gpu/results/weak_filtered"
mkdir -p "${RESULTS}" log
...
for D in 128 512; do
    for NP in 1 2 4 8; do
        ...
        export TIMING_CSV="${RESULTS}/timing_${nx_full}_${npxnpynpz}_filtered_v2.csv"
        echo
